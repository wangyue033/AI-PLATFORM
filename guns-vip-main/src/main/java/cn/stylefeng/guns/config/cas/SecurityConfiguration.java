...
public class SecurityConfiguration {
	...
	public CasAuthenticationFilter casAuthenticationFilter(AuthenticationManager auth, ServiceProperties serviceProperties) {
        ...
        //设置认证成功后的处理handler
		casAuthenticationFilter.setAuthenticationSuccessHandler(new SimpleUrlAuthenticationSuccessHandler("/guns/login"));
	...
	public LogoutFilter logoutFilter() {
		String logoutRedirectPath = casServerProperties.getCasServerLogoutUrl()+ "?service=" +casServerProperties.getServerName()+"/logout";
