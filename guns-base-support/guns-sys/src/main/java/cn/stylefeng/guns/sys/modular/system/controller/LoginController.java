...
public class LoginController extends BaseController {
     ...
     * @Date 2018/12/23 5:42 PM
     */
    @RequestMapping(value = "/logoutbak")
    @ResponseBody
    ...
    public void logout(HttpServletRequest request, HttpServletResponse resp) throws Exception {
        authService.logout();
        resp.sendRedirect("redirect:http://localhost:8080/cas/logout?service=http://localhost:8088/guns/logoutSuccess");
    }

    @RequestMapping("logout")
    public ModelAndView alipayforward(HttpServletRequest req, HttpServletResponse resp) throws Exception {
        authService.logout();
        String url = "redirect:http://localhost:8080/cas/logout?service=http://localhost:8088/guns/logoutSuccess";
