...
public class UserService extends ServiceImpl<UserMapper, User> {
    ...
    public void addUser(UserDto user) {
        ...
        String passwordCas = SecureUtil.md5(user.getPassword());

        User newUser = UserFactory.createUser(user, password, salt, passwordCas);
        this.save(newUser);
    ...
    public void changePwd(String oldPassword, String newPassword) {
        ...
        if (user.getPassword().equals(oldMd5)) {
            ...
            String passwordCas = SecureUtil.md5(newPassword);
            user.setPasswordCas(passwordCas);
